...
public class HierarchicalExpressionPrinter
{
    ...
    private void Print(Expression e, int indentation)
    {
        ...
        else if (e is BinaryMinus binaryMinus)
        {
